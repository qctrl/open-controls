...
setup(
    ...
    extras_require={"dev": ["black==19.*,>=19.10.0.b0", "isort==4.*,>=4.3.21", "nbval==0.*,>=0.9.5", "pylint==2.*,>=2.3.0", "pylint-runner==0.*,>=0.5.4", "pytest==5.*,>=5.0.0", "qctrl-visualizer==2.*,>=2.1.0", "sphinx==2.*,>=2.2.0", "sphinx-rtd-theme==0.*,>=0.4.3"]},
)
